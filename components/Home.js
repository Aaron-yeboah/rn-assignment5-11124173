    ...
    <SafeAreaView>
        ...
        <View style={{display: 'flex', flexDirection: 'row',marginHorizontal: 10}}>
            ...
            <View style={{marginHorizontal:10, marginVertical: 20}}>
                ...
                <Text style={{fontSize:20,marginVertical:5, color: colors.text}}>Aaron Yeboah</Text>
            </View>
            <View style={{marginVertical: 20,backgroundColor: '#f4f4f4',borderRadius: 100,height: 40,width: 40,justifyContent: 'center',alignItems: 'center',marginHorizontal:120}}>
                <Image source={Search} />
            </View>
        </View>
        ...
        <TouchableOpacity style={{display: 'flex',flexDirection: 'row',marginVertical: 20,marginHorizontal: 30, gap: 50}}>
            <View>
        ...
        <View style={{display: 'flex', flexDirection:'row',gap: 220,marginHorizontal: 20,marginVertical:20}}>
